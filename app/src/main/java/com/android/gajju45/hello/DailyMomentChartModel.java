...
public class DailyMomentChartModel {

    String tourid, tourdate, destination, ageName, leadPax, pickuptime, droptime, mode, driver, vehicleName, vehicleAllocation;

    public DailyMomentChartModel() {
    }

    public DailyMomentChartModel(String tourid, String tourdate, String destination, String ageName, String leadPax, String pickuptime, String droptime, String mode, String driver, String vehicleName, String vehicleAllocation) {
        this.tourid = tourid;
