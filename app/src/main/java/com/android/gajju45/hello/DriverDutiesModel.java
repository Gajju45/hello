...
public class DriverDutiesModel {
    ...
    public DriverDutiesModel(String tourid, String tourdate, String destination, String ageName, String leadPax, String pickuptime, String droptime, String mode, String driver, String vehicleName, String vehicleAllocation) {
        this.tourid = tourid;
